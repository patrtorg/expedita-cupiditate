...
[![npm](https://img.shields.io/npm/v/@patrtorg/expedita-cupiditate.svg)](https://www.npmjs.com/package/@patrtorg/expedita-cupiditate)
[![downloads](https://img.shields.io/npm/dt/@patrtorg/expedita-cupiditate.svg)](https://www.npmjs.com/package/@patrtorg/expedita-cupiditate)
[![types](https://img.shields.io/npm/types/@patrtorg/expedita-cupiditate.svg)](https://www.npmjs.com/package/@patrtorg/expedita-cupiditate)
[![licence](https://img.shields.io/github/license/mnasyrov/@patrtorg/expedita-cupiditate.svg)](https://github.com/patrtorg/expedita-cupiditate/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@patrtorg/expedita-cupiditate/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@patrtorg/expedita-cupiditate?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@patrtorg/expedita-cupiditate**][@patrtorg/expedita-cupiditate/docs]             | Core elements, state and effect management | [Docs][@patrtorg/expedita-cupiditate/docs], [API][@patrtorg/expedita-cupiditate/api]             |
| [**@patrtorg/expedita-cupiditate-react**][@patrtorg/expedita-cupiditate-react/docs] | Tooling for React.js                       | [Docs][@patrtorg/expedita-cupiditate-react/docs], [API][@patrtorg/expedita-cupiditate-react/api] |
...
```
npm install @patrtorg/expedita-cupiditate @patrtorg/expedita-cupiditate-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@patrtorg/expedita-cupiditate';
...
import { useConst, useObservable, useQuery } from '@patrtorg/expedita-cupiditate-react';
...
[@patrtorg/expedita-cupiditate/docs]: packages/@patrtorg/expedita-cupiditate/README.md
[@patrtorg/expedita-cupiditate/api]: packages/@patrtorg/expedita-cupiditate/docs/README.md
[@patrtorg/expedita-cupiditate-react/docs]: packages/@patrtorg/expedita-cupiditate-react/README.md
[@patrtorg/expedita-cupiditate-react/api]: packages/@patrtorg/expedita-cupiditate-react/docs/README.md
